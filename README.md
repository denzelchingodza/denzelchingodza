...
Final year BSc IT Software Engineering student. Python first, backend heavy, and increasingly deep in AI engineering (RAG pipelines, fine-tuning, vector search, the infrastructure underneath the models).
